...
module.exports = async bot => {
  ...
  bot.tags = {
    ...
    "enregistrement" : "N'oubliez pas de valider votre présence au tournoi dans https://discord.com/channels/1221611301332193371/1227020880614260866 sinon on va se tape :chopan_pouce:",
    "picpus" : "https://maps.app.goo.gl/Pqqkx2S8ZfM2xv7J8",

    "1on1" : "Dans le règlement **1 on 1** chaque joueur assemble et ne joue **qu'une seule et même toupie** lors de l'intégralité du tournoi, les matchs sont joués en 4 points avec la règle du gain de point en fonction du finish (xtreme, burst, over, spin).",
    "3on3" : "Dans le règlement **3 on 3** chaque joueur assemble 3 toupies en n'utilisant **aucun composant en double**, lors d'un match le joueur joue 1 round avec chaque toupie dans l'ordre qu'il le souhaite, pour déterminer le vainqueur on note le cumul des résultats des 3 matchs avec la règle du gain de point en fonction du finish (xtreme, burst, over, spin).",
