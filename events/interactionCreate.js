...
module.exports = async (bot, interaction) => {
  ...
  if (interaction.type === Discord.InteractionType.ApplicationCommand) { require(`../commands/${interaction.commandName}`).run(bot, interaction, interaction.options) }
    ...
    if (focusedOption.name === "place") { choices = ["Dernier Bar avant la Fin du Monde, Paris", "Square Courteline (Picpus), Paris", "Place de la Nation, Paris", "Baraka Jeux, Marseille"] }
