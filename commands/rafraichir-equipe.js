...
module.exports = {
  ...
  async run(bot, message, args) {
    ...
    for (team of teams) await require(`../commands/modif-equipe.js`).run(bot, message, args, {team_id : team.dataValues.team_id, post_resource : team.dataValues.team_logo.split('/')[0]})
